        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light fixed-top padding_nav bgs border-0 border-bottom border-secondary border-3">
                <div className="container-fluid">
                    <Link  to='/admin/home' className="navbar-brand fs-2 fw-bold"><img src={adeLogo} alt='our logo' className='rounded-circle' width='60'/></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ms-5" style={{ marginLeft: '6vh' }}>
                            ...
                            <li className="nav-item ms-3">
                                <NavLink activeClassName="active" to='/admin/customers' className="nav-link  fw-bold" data-bs-toggle="tooltip" data-bs-placement="top" title="Staff list">Staff List</NavLink>
                            </li>
                            <li className="nav-item ms-3">
                                <NavLink activeClassName="active" to='/admin/addProduct' className="nav-link fw-bold  position-relative" data-bs-toggle="tooltip" data-bs-placement="top" title="Upload Product"> Add New product </NavLink>
                            </li>
                        </ul>
