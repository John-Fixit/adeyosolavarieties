                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ms-5" style={{ marginLeft: '6vh' }}>
                            <li className="nav-item ms-3">
                                <NavLink activeClassName="active" to='/admin' className="nav-link fw-bold text-light " data-bs-toggle="tooltip" data-bs-placement="top" title="Admin Home">Home</NavLink>
                            </li>
                            <li className="nav-item ms-3">
                                <NavLink activeClassName="active" to='/admin/customers' className="nav-link  fw-bold text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Staff list">Staff List</NavLink>
                            </li>
                            <li className="nav-item ms-3">
                                <NavLink activeClassName="active" to='/admin/addProduct' className="nav-link fw-bold text-light position-relative" data-bs-toggle="tooltip" data-bs-placement="top" title="Upload Product"> upload products </NavLink>
                            </li>
                        </ul>
